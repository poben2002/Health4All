...
function SubCard({ title, description }) {
  return (
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        {sections.map((section, idx) => (
          <div key={idx} className="mb-10 mt-5 text-left">
            ...
            {/* <div className="mt-4">
              <button className="px-4 py-2 bg-black text-white rounded-xl hover:bg-blue-700 transition">
                Learn More
              </button>
            </div> */}
              {title === "Education" && (
        <button className="mt-4 px-4 py-2 bg-black text-white rounded-xl hover:bg-blue-700 transition">
          Learn More
        </button>
      )}
          </div>
